...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<?php endif; ?>
				<a href="index.php?page=Students_attendance" class="nav-item nav-Students_attendance"><span class='icon-field'><i class="fa fa-tasks "></i></span> Students Attendance</a>
